...
func NewPeerServer(peer *Peer) *PeerServer {
	return &PeerServer{
		peer:         peer,
...
func (s *PeerServer) ProcessBlock(ctx context.Context, block *pb.Block) (*pb.ProcessBlockResponse, error) {
	...
	channel, err := s.peer.channelManager.GetChannel(block.ChannelId)
	if err != nil {
...
func (s *PeerServer) validateTransactions(block *pb.Block, channel *Channel) (int32, int32) {
...
func (s *PeerServer) validateTransaction(tx *pb.Transaction, channel *Channel) error {
	if tx == nil {
...
func (s *PeerServer) convertToInternalBlock(pbBlock *pb.Block) *Block {
	return &Block{
...
func (s *PeerServer) extractTransactions(block *pb.Block) []*Transaction {
...
func (s *PeerServer) convertToProtobufBlock(block *Block, channelId string) *pb.Block {
	return &pb.Block{
		Number:       block.Number,
